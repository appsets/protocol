...
from openapi.v1 import user_pb2 as openapi_dot_v1_dot_user__pb2
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'appsets.openapi.v1.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('appsets.openapi.v1.UserService', rpc_method_handlers)
