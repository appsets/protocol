...
const (
	AccountService_AuthenticateEmail_FullMethodName = "/appsets.api.client.v1.AccountService/AuthenticateEmail"
	AccountService_RefreshToken_FullMethodName      = "/appsets.api.client.v1.AccountService/RefreshToken"
)
...
func _AccountService_AuthenticateEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthenticateEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).AuthenticateEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_AuthenticateEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).AuthenticateEmail(ctx, req.(*AuthenticateEmailRequest))
	}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "appsets.api.client.v1.AccountService",
	HandlerType: (*AccountServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AuthenticateEmail",
			Handler:    _AccountService_AuthenticateEmail_Handler,
		},
		{
