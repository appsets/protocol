...
func (h *PurchaseServiceHTTPConverter) InitializePurchaseAlipay(onError func(ctx context.Context, w http.ResponseWriter, r *http.Request, arg, ret proto.Message, err error), interceptors ...grpc.UnaryServerInterceptor) http.HandlerFunc {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		info := &grpc.UnaryServerInfo{
			Server:     h.srv,
			FullMethod: "/appsets.api.client.v1.PurchaseService/InitializePurchaseAlipay",
		}
		...
		if !ok {
			onError(ctx, w, r, arg, nil, fmt.Errorf("/appsets.api.client.v1.PurchaseService/InitializePurchaseAlipay: interceptors have not return InitializePurchaseAlipayResponse"))
			return
		}
...
func (h *PurchaseServiceHTTPConverter) ValidatePurchaseAlipay(onError func(ctx context.Context, w http.ResponseWriter, r *http.Request, arg, ret proto.Message, err error), interceptors ...grpc.UnaryServerInterceptor) http.HandlerFunc {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		info := &grpc.UnaryServerInfo{
			Server:     h.srv,
			FullMethod: "/appsets.api.client.v1.PurchaseService/ValidatePurchaseAlipay",
		}
		...
		if !ok {
			onError(ctx, w, r, arg, nil, fmt.Errorf("/appsets.api.client.v1.PurchaseService/ValidatePurchaseAlipay: interceptors have not return ValidatePurchaseAlipayResponse"))
			return
		}
...
func (h *PurchaseServiceHTTPConverter) CancelPurchase(onError func(ctx context.Context, w http.ResponseWriter, r *http.Request, arg, ret proto.Message, err error), interceptors ...grpc.UnaryServerInterceptor) http.HandlerFunc {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		info := &grpc.UnaryServerInfo{
			Server:     h.srv,
			FullMethod: "/appsets.api.client.v1.PurchaseService/CancelPurchase",
		}
		...
		if !ok {
			onError(ctx, w, r, arg, nil, fmt.Errorf("/appsets.api.client.v1.PurchaseService/CancelPurchase: interceptors have not return CancelPurchaseResponse"))
			return
		}
