...
func (h *UserServiceHTTPConverter) Get(onError func(ctx context.Context, w http.ResponseWriter, r *http.Request, arg, ret proto.Message, err error), interceptors ...grpc.UnaryServerInterceptor) http.HandlerFunc {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		info := &grpc.UnaryServerInfo{
			Server:     h.srv,
			FullMethod: "/appsets.api.developer.v1.UserService/Get",
		}
		...
		if !ok {
			onError(ctx, w, r, arg, nil, fmt.Errorf("/appsets.api.developer.v1.UserService/Get: interceptors have not return GetUserResponse"))
			return
		}
...
func (h *UserServiceHTTPConverter) Create(onError func(ctx context.Context, w http.ResponseWriter, r *http.Request, arg, ret proto.Message, err error), interceptors ...grpc.UnaryServerInterceptor) http.HandlerFunc {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		info := &grpc.UnaryServerInfo{
			Server:     h.srv,
			FullMethod: "/appsets.api.developer.v1.UserService/Create",
		}
		...
		if !ok {
			onError(ctx, w, r, arg, nil, fmt.Errorf("/appsets.api.developer.v1.UserService/Create: interceptors have not return CreateUserResponse"))
			return
		}
